...
extension StoryScript {
    ...
    static let hanselAndGretel = StoryScript(
        ...
        cues: [
            // 오프닝 — "시작"이라고 말하면 동화 오프닝 음악이 흐르고,
            // 첫 효과음 큐가 나올 때 자연스럽게 교체된다
            StoryCue(
                id: "hg_00",
                text: "자, 이제 「헨젤과 그레텔」 이야기를 시작할게요. 모두 귀를 쫑긋 세워 볼까요?",
                keyword: "시작",
    ...
    static let littleRedRidingHood = StoryScript(
        ...
        cues: [
            ...
            StoryCue(
                id: "lrrh_00",
                text: "자, 이제 「빨간 모자」 이야기를 시작할게요. 모두 귀를 쫑긋 세워 볼까요?",
                keyword: "시작",
                soundID: "once_upon_time"
            ),
            StoryCue(
    ...
    static let cinderella = StoryScript(
        ...
        cues: [
            ...
            StoryCue(
                id: "cin_00",
                text: "자, 이제 「신데렐라」 이야기를 시작할게요. 모두 귀를 쫑긋 세워 볼까요?",
                keyword: "시작",
                soundID: "once_upon_time"
            ),
            StoryCue(
    ...
    static let threeLittlePigs = StoryScript(
        ...
        cues: [
            ...
            StoryCue(
                id: "tlp_00",
                text: "자, 이제 「아기 돼지 삼형제」 이야기를 시작할게요. 모두 귀를 쫑긋 세워 볼까요?",
                keyword: "시작",
                soundID: "once_upon_time"
            ),
            StoryCue(
            ...
            StoryCue(
                id: "tlp_02",
                text: "게으른 첫째 돼지는 들판에서 지푸라기를 발견했어요. '이걸로 집을 지으면 금방 끝나겠는걸?' 첫째는 지푸라기를 대충 쌓아 반나절 만에 집을 완성하고 낮잠을 자러 갔어요.",
                keyword: "지푸라기를",
                soundID: "leaves_rustle"
            ),
            StoryCue(
                id: "tlp_03",
                text: "둘째 돼지는 숲에서 나뭇가지를 주워 왔어요. 뚝딱뚝딱, 나무를 얼기설기 엮어 집을 지었지요. '이 정도면 튼튼하지!' 둘째도 하루 만에 집을 다 짓고 놀러 나갔어요.",
                keyword: "뚝딱뚝딱",
                soundID: "axe_chop"
            ),
            StoryCue(
            ...
            StoryCue(
                id: "tlp_05",
                text: "그러던 어느 날, 산 너머에서 배고픈 늑대가 어슬렁어슬렁 내려왔어요. 늑대는 아기 돼지 냄새를 맡고 침을 꿀꺽 삼키며 낮게 으르렁거렸지요.",
                keyword: "늑대가",
                soundID: "wolf_growl",
                delay: 0.5
            ),
            StoryCue(
                id: "tlp_06",
                text: "늑대는 먼저 첫째 돼지의 지푸라기 집으로 가서 쿵쿵 문을 두드렸어요. '아기 돼지야, 문 열어라!' '싫어요, 절대 안 열어 줄 거예요!'",
                keyword: "문을 두드렸어요",
                soundID: "door_knock"
            ),
            StoryCue(
            ...
            StoryCue(
                id: "tlp_08",
                text: "그러자 지푸라기 집이 힘없이 무너져 버렸어요! 첫째 돼지는 깜짝 놀라 꿀꿀 소리를 지르며 뛰쳐나왔어요.",
                keyword: "무너져",
                soundID: "house_collapse"
            ),
            StoryCue(
                id: "tlp_09",
                text: "첫째 돼지는 걸음아 나 살려라 하고 둘째 형의 나무 집으로 달려갔어요. 늑대도 혀를 날름거리며 그 뒤를 쫓아왔지요.",
                keyword: "달려갔어요",
                soundID: "footstep_run"
            ),
            StoryCue(
            ...
            StoryCue(
                id: "tlp_11",
                text: "나무 집이 와르르 무너지고 말았어요! 첫째와 둘째 돼지는 서로 부둥켜안고 벌벌 떨다가 막내의 벽돌집으로 죽을힘을 다해 도망쳤답니다.",
                keyword: "와르르",
                soundID: "house_collapse"
            ),
            StoryCue(
            ...
            StoryCue(
                id: "tlp_13",
                text: "'좋아, 그럼 굴뚝으로 들어가 주지!' 늑대는 지붕 위로 영차영차 기어올라 굴뚝을 타고 내려가기 시작했어요.",
                keyword: "굴뚝으로",
                soundID: "climbing",
                delay: 0.5
            ),
            ...
            StoryCue(
                id: "tlp_15",
                text: "굴뚝을 타고 내려온 늑대는 그대로 끓는 솥에 풍덩 빠지고 말았어요! '으악, 뜨거워!'",
                keyword: "풍덩",
    ...
    static let tortoiseAndHare = StoryScript(
        ...
        cues: [
            ...
            StoryCue(
                id: "th_00",
                text: "자, 이제 「토끼와 거북이」 이야기를 시작할게요. 모두 귀를 쫑긋 세워 볼까요?",
                keyword: "시작",
                soundID: "once_upon_time"
            ),
            StoryCue(
            ...
            StoryCue(
                id: "th_02",
                text: "'나를 봐! 폴짝폴짝 한 번 뛰면 벌써 저 언덕이라고!' 토끼는 느릿느릿 걸어가는 거북이를 보고 킥킥 웃으며 놀렸어요. '거북아, 너는 세상에서 제일 느림보야!'",
                keyword: "폴짝폴짝",
                soundID: "jumping"
            ),
            StoryCue(
                id: "th_03",
                text: "거북이는 화를 내는 대신 조용히 말했어요. '토끼야, 그럼 나와 달리기 경주를 해 볼래? 저 산꼭대기 큰 나무까지 말이야.' 토끼는 배꼽을 잡고 웃었어요. '좋아! 내가 이기는 건 뻔하지만!'"
            ),
            StoryCue(
                id: "th_04",
                text: "경주 날이 되자 숲속 동물들이 모두 모였어요. 부엉이 심판이 높이 나팔을 불어 경주의 시작을 알렸어요!",
                keyword: "나팔을",
                soundID: "trumpet_fanfare",
                delay: 0.5
            ),
            StoryCue(
                id: "th_05",
                text: "토끼는 쌩하고 바람처럼 달려 나갔어요. 눈 깜짝할 사이에 거북이는 까마득히 뒤처지고 말았지요.",
                keyword: "쌩하고",
                soundID: "footstep_run"
            ),
            StoryCue(
            ...
            StoryCue(
                id: "th_07",
                text: "'거북이가 여기까지 오려면 한참 멀었네. 시원한 그늘에서 낮잠이나 자 볼까?' 토끼는 나무 그늘에 벌러덩 누워 쿨쿨 잠이 들었어요.",
                keyword: "낮잠이나",
                soundID: "snoring",
                delay: 1.0
            ),
            StoryCue(
                id: "th_08",
                text: "그동안 거북이는 쉬지 않고 뚜벅뚜벅 걸었어요. 힘들어도 멈추지 않았고, 땀이 흘러도 포기하지 않았어요.",
                keyword: "뚜벅뚜벅",
                soundID: "footstep_walk"
            ),
            StoryCue(
                id: "th_09",
                text: "거북이는 잠든 토끼 옆을 조용히 지나갔어요. 그리고 한 걸음 한 걸음, 산꼭대기를 향해 계속 올라갔답니다."
            ),
            StoryCue(
                id: "th_10",
                text: "얼마나 지났을까, 토끼가 눈을 번쩍 떴어요. '아차, 내가 너무 오래 잤나?' 저 멀리 산꼭대기를 올려다본 토끼는 소스라치게 놀랐어요. 거북이가 결승선 바로 앞에 있는 게 아니겠어요!",
                keyword: "번쩍",
                soundID: "gasp_surprise"
            ),
            StoryCue(
                id: "th_11",
                text: "토끼는 온 힘을 다해 달리고 또 달렸어요. 하지만 이미 늦고 말았지요.",
                keyword: "온 힘을",
                soundID: "footstep_run"
            ),
            StoryCue(
                id: "th_12",
                text: "거북이가 먼저 결승선을 통과했어요! 숲속 동물들이 모두 뛰어나와 환호하며 박수를 쳤답니다. '거북이 만세! 거북이가 이겼다!'",
                keyword: "결승선을",
                soundID: "cheer_crowd",
                delay: 0.3
            ),
    ...
    static let snowWhite = StoryScript(
        ...
        cues: [
            ...
            StoryCue(
                id: "sw_00",
                text: "자, 이제 「백설공주」 이야기를 시작할게요. 모두 귀를 쫑긋 세워 볼까요?",
                keyword: "시작",
                soundID: "once_upon_time"
            ),
            StoryCue(
                id: "sw_01",
                text: "옛날 어느 왕국에 눈처럼 하얀 피부와 흑단처럼 까만 머리카락을 가진 공주가 태어났어요. 사람들은 공주를 백설공주라고 불렀지요. 하지만 왕비가 세상을 떠나고, 왕은 새 왕비를 맞이했답니다."
            ),
            StoryCue(
                id: "sw_02",
                text: "새 왕비에게는 신기한 마법 거울이 있었어요. 왕비는 날마다 물었지요. '거울아, 거울아, 이 세상에서 누가 제일 아름답니?' 그러면 거울은 언제나 '왕비님이 제일 아름답습니다'라고 대답했어요.",
                keyword: "거울아",
            ...
            StoryCue(
                id: "sw_04",
                text: "사냥꾼은 백설공주를 데리고 깊은 숲속으로 들어갔어요. 하지만 착한 사냥꾼은 차마 공주를 해칠 수 없었어요. '공주님, 어서 멀리 도망가세요. 그리고 절대 성으로 돌아오시면 안 됩니다.'",
                keyword: "숲속으로",
                soundID: "forest_ambience"
            ),
            StoryCue(
                id: "sw_05",
                text: "백설공주는 가시덤불을 헤치며 숲속 깊은 곳으로 정신없이 달아났어요. 해가 질 무렵, 공주는 작고 아담한 오두막 한 채를 발견했답니다.",
                keyword: "달아났어요",
                soundID: "footstep_run"
            ),
            StoryCue(
                id: "sw_06",
                text: "공주가 문을 살며시 열자 삐걱 소리와 함께 아기자기한 방이 나타났어요. 작은 식탁에는 접시 일곱 개, 벽 쪽에는 작은 침대가 일곱 개 놓여 있었지요. 지친 공주는 침대에 누워 곤히 잠들었어요.",
                keyword: "살며시",
                soundID: "door_creak"
            ),
            StoryCue(
                id: "sw_07",
                text: "밤이 되자 오두막의 주인인 일곱 난쟁이들이 즐겁게 노래를 부르며 돌아왔어요. 광산에서 보석을 캐고 오는 길이었지요.",
                keyword: "노래를",
            ...
            StoryCue(
                id: "sw_09",
                text: "한편 성에서 왕비가 다시 거울에게 물었어요. '거울아, 거울아, 이 세상에서 누가 제일 아름답니?' '일곱 난쟁이와 사는 백설공주님이 제일 아름답습니다.' 왕비는 공주가 살아 있다는 것을 알고 부들부들 떨었어요.",
                keyword: "거울아",
                soundID: "mirror_magic"
            ),
            StoryCue(
                id: "sw_10",
                text: "왕비는 독을 바른 새빨간 사과를 만들었어요. 그리고 마법을 부려 꼬부랑 할멈으로 변신했지요. 왕비는 소름 끼치는 웃음을 흘리며 숲으로 향했어요.",
                keyword: "할멈으로",
                soundID: "witch_cackle",
                delay: 0.5
            ),
            ...
            StoryCue(
                id: "sw_13",
                text: "공주는 그 자리에 힘없이 쓰러지고 말았어요. 할멈은 낄낄 웃으며 사라졌지요.",
                keyword: "쓰러지고",
                soundID: "falling"
            ),
            StoryCue(
                id: "sw_14",
                text: "돌아온 난쟁이들은 쓰러진 공주를 보고 슬피 울었어요. 난쟁이들은 공주를 유리관에 눕히고 밤낮으로 곁을 지켰답니다.",
                keyword: "슬피",
                soundID: "crying"
            ),
            StoryCue(
                id: "sw_15",
                text: "그러던 어느 날, 이웃 나라 왕자님이 하얀 말을 타고 숲을 지나가다 유리관 속 공주를 보았어요. 왕자는 공주의 아름다움에 마음을 빼앗기고 말았지요.",
                keyword: "말을 타고",
                soundID: "horse_gallop",
                delay: 0.5
            ),
            ...
            StoryCue(
                id: "sw_17",
                text: "백설공주와 왕자님은 성대한 결혼식을 올렸어요. 나쁜 왕비는 벌을 받아 멀리 쫓겨났고, 공주는 일곱 난쟁이를 자주 초대하며 오래오래 행복하게 살았답니다.",
                keyword: "행복하게",
                soundID: "happy_ending"
            ),
        ]
    ...
    static let jackAndBeanstalk = StoryScript(
        ...
        cues: [
            ...
            StoryCue(
                id: "jb_00",
                text: "자, 이제 「잭과 콩나무」 이야기를 시작할게요. 모두 귀를 쫑긋 세워 볼까요?",
                keyword: "시작",
                soundID: "once_upon_time"
            ),
            StoryCue(
            ...
            StoryCue(
                id: "jb_02",
                text: "시장 가는 길에 한 할아버지가 잭을 불렀어요. '그 소를 나에게 주면 이 신비한 마법 콩을 주마. 하룻밤이면 하늘까지 자라는 콩이란다!' 콩이 반짝반짝 빛나자 잭은 홀린 듯 소와 바꾸고 말았어요.",
                keyword: "마법 콩",
                soundID: "magic_sparkle"
            ),
            StoryCue(
            ...
            StoryCue(
                id: "jb_05",
                text: "'저 위엔 뭐가 있을까?' 호기심 많은 잭은 콩나무 줄기를 붙잡고 영차영차 오르기 시작했어요. 오르고 또 올라 마침내 구름 위에 도착했지요.",
                keyword: "오르기",
                soundID: "climbing"
            ),
            StoryCue(
                id: "jb_06",
                text: "구름 위에는 어마어마하게 큰 성이 있었어요. 잭이 다가가자 육중한 성문이 끼이이익 소리를 내며 열렸어요. 잭은 살그머니 안으로 들어갔답니다.",
                keyword: "성문이",
                soundID: "castle_gate"
            ),
            StoryCue(
                id: "jb_07",
                text: "그때 저 멀리서 무시무시한 발소리가 들려왔어요. 쿵! 쿵! 쿵! 성이 흔들릴 만큼 커다란 거인이 나타났어요!",
                keyword: "발소리가",
            ...
            StoryCue(
                id: "jb_09",
                text: "거인이 외쳤어요. '암탉아, 황금알을 낳아라!' 그러자 암탉이 꼬꼬댁 울더니 반짝이는 황금알을 툭 낳았어요. 잭은 눈이 휘둥그레졌답니다.",
                keyword: "암탉이",
                soundID: "hen_cluck",
                delay: 0.3
            ),
            ...
            StoryCue(
                id: "jb_12",
                text: "잭은 있는 힘껏 도망쳤어요! 거인이 성큼성큼 뒤쫓아 왔지만, 몸이 작고 날쌘 잭이 먼저 콩나무에 매달려 미끄러지듯 내려갔지요.",
                keyword: "도망쳤어요",
                soundID: "footstep_run"
            ),
            StoryCue(
            ...
            StoryCue(
                id: "jb_14",
                text: "우지끈! 콩나무가 기울더니 거인과 함께 우르르 쓰러졌어요. 거인은 땅이 울리도록 쿵 떨어져서는 걸음아 나 살려라 하고 하늘나라로 도망가 버렸답니다.",
                keyword: "우르르",
    ...
    static let bremenMusicians = StoryScript(
        ...
        cues: [
            ...
            StoryCue(
                id: "bm_00",
                text: "자, 이제 「브레멘 음악대」 이야기를 시작할게요. 모두 귀를 쫑긋 세워 볼까요?",
                keyword: "시작",
                soundID: "once_upon_time"
            ),
            StoryCue(
                id: "bm_01",
                text: "옛날 어느 마을에 늙은 당나귀가 살았어요. 주인은 힘이 빠진 당나귀를 내쫓으려 했지요. 당나귀는 슬프게 울고는 결심했어요. '그래, 브레멘에 가서 음악대가 되는 거야!'",
                keyword: "당나귀가",
                soundID: "donkey_bray",
                delay: 0.5
            ),
            StoryCue(
                id: "bm_02",
                text: "길을 가던 당나귀는 풀숲에 축 늘어져 있는 늙은 사냥개 한 마리를 만났어요. '나는 이제 사냥을 못 해서 쫓겨났어, 멍멍.' '그럼 나랑 브레멘에 가서 음악대를 하자!'",
                keyword: "사냥개",
                soundID: "dog_bark",
                delay: 0.5
            ),
            StoryCue(
                id: "bm_03",
                text: "조금 더 가자 지붕 위에 시무룩하게 앉아 있는 늙은 고양이가 보였어요. '나는 쥐를 못 잡는다고 쫓겨났어, 야옹.' '우리랑 같이 가자! 넌 세레나데를 부르면 되겠다!'",
                keyword: "고양이가",
                soundID: "cat_meow",
                delay: 0.5
            ),
            StoryCue(
                id: "bm_04",
                text: "마을 어귀에서는 수탉이 울타리 위에서 목청껏 울고 있었어요. '내일 손님상에 오를 처지라네!' '그럼 우리랑 브레멘으로 가자! 네 목소리는 최고의 트럼펫이야!'",
                keyword: "수탉이",
            ...
            StoryCue(
                id: "bm_05",
                text: "이렇게 당나귀, 사냥개, 고양이, 수탉 네 친구는 브레멘을 향해 길을 떠났어요. 하지만 브레멘은 멀고도 멀어서 하루 만에 도착할 수 없었지요."
            ),
            StoryCue(
                id: "bm_06",
                text: "밤이 되자 네 친구는 어두운 숲에서 하룻밤을 지내기로 했어요. 사방이 깜깜하고 풀벌레 소리만 가득했지요.",
                keyword: "밤이 되자",
            ...
            StoryCue(
                id: "bm_10",
                text: "'하나, 둘, 셋!' 네 친구는 목청껏 소리 높여 노래했어요! 히힝! 멍멍! 야옹! 꼬끼오! 세상에서 가장 요란한 합창이 울려 퍼졌지요.",
                keyword: "목청껏",
                soundID: "donkey_bray",
                delay: 0.3
            ),
            ...
            StoryCue(
                id: "bm_12",
                text: "네 친구는 집으로 들어가 남겨진 음식을 배불리 맛있게 먹었어요. 그리고 각자 편한 자리를 찾아 곤히 잠들었지요.",
                keyword: "맛있게",
                soundID: "eating_crunching"
            ),
            StoryCue(
                id: "bm_13",
                text: "한밤중, 도둑 한 명이 상황을 살피러 살금살금 집으로 돌아왔어요. 집 안은 조용하고 깜깜했지요.",
                keyword: "살금살금",
            ...
            StoryCue(
                id: "bm_15",
                text: "도둑은 걸음아 나 살려라 하고 줄행랑을 쳤어요. '그 집엔 무시무시한 괴물들이 살고 있어!' 도둑들은 다시는 그 집 근처에 얼씬도 하지 않았지요.",
                keyword: "줄행랑",
                soundID: "footstep_run"
            ),
            StoryCue(
    ...
    static let wolfAndSevenGoats = StoryScript(
        ...
        cues: [
            ...
            StoryCue(
                id: "sg_00",
                text: "자, 이제 「늑대와 일곱 마리 아기 염소」 이야기를 시작할게요. 모두 귀를 쫑긋 세워 볼까요?",
                keyword: "시작",
                soundID: "once_upon_time"
            ),
            StoryCue(
                id: "sg_01",
                text: "옛날 옛날, 엄마 염소와 귀여운 일곱 마리 아기 염소가 살았어요. 아기 염소들은 매애매애 울며 엄마 곁을 졸졸 따라다녔지요.",
                keyword: "아기 염소",
                soundID: "goat_bleat",
                delay: 0.3
            ),
            ...
            StoryCue(
                id: "sg_04",
                text: "'얘들아, 엄마다. 문 열어 주렴.' 하지만 그 목소리는 몹시 거칠고 낮았어요. 아기 염소들이 외쳤어요. '거짓말! 우리 엄마 목소리는 곱단 말이야. 너는 늑대지!'",
                keyword: "거칠고",
                soundID: "wolf_growl",
                delay: 0.3
            ),
            StoryCue(
                id: "sg_05",
                text: "늑대는 가게로 달려가 분필을 꿀꺽 삼켰어요. 그러자 목소리가 고와졌지요. 늑대는 다시 염소네 집으로 갔어요."
            ),
            StoryCue(
                id: "sg_06",
                text: "늑대가 다시 문을 두드리며 고운 목소리로 말했어요. '얘들아, 엄마 왔다.' 그런데 창틀에 올려놓은 발이 새까맸어요! '우리 엄마 발은 하얗단 말이야. 너는 늑대지!'",
                keyword: "다시 문을",
                soundID: "door_knock"
            ),
            StoryCue(
                id: "sg_07",
                text: "약이 오른 늑대는 방앗간으로 달려가 발에 하얀 밀가루 반죽을 잔뜩 발랐어요. 그리고 세 번째로 염소네 집을 찾아갔지요."
            ),
            StoryCue(
                id: "sg_08",
                text: "고운 목소리에 하얀 발까지 본 아기 염소들은 그만 문을 열어 주었어요. 문이 스르륵 열리자, 그곳엔 커다란 늑대가 서 있었답니다!",
                keyword: "열어 주었어요",
                soundID: "door_creak"
            ),
            StoryCue(
                id: "sg_09",
                text: "'늑대다!' 아기 염소들은 비명을 지르며 사방으로 숨었어요. 식탁 밑으로, 이불 속으로, 아궁이 속으로, 저마다 꼭꼭 숨었지요.",
                keyword: "비명을",
                soundID: "scream"
            ),
            StoryCue(
            ...
            StoryCue(
                id: "sg_12",
                text: "집에 돌아온 엄마 염소는 엉망이 된 집안을 보고 울음을 터뜨렸어요. '아가들아, 내 아가들아, 어디 있니!'",
                keyword: "터뜨렸어요",
                soundID: "crying"
            ),
            StoryCue(
                id: "sg_13",
                text: "그때 괘종시계 문이 빼꼼 열리더니 막내가 기어 나왔어요. '엄마, 늑대가 언니 오빠들을 모두 삼켜 버렸어요!' 막내는 매애매애 울며 엄마 품에 안겼지요.",
                keyword: "막내가",
                soundID: "goat_bleat",
                delay: 0.3
            ),
            StoryCue(
                id: "sg_14",
                text: "엄마 염소는 막내와 함께 풀밭으로 달려갔어요. 잠든 늑대의 배가 꿈틀꿈틀 움직이고 있는 게 아니겠어요! 엄마는 가위로 늑대의 배를 살짝 가르고 여섯 아기를 모두 꺼냈어요. 그리고 그 자리에 무거운 돌멩이를 가득 채워 꿰맸답니다."
            ),
            StoryCue(
                id: "sg_15",
            ...
            StoryCue(
                id: "sg_16",
                text: "'늑대가 빠졌다! 늑대가 빠졌다!' 일곱 아기 염소는 엄마와 함께 우물 주위를 빙글빙글 돌며 덩실덩실 춤을 추었어요. 그리고 모두 오래오래 행복하게 살았답니다.",
                keyword: "행복하게",
                soundID: "happy_ending"
            ),
        ]
    ...
    static let uglyDuckling = StoryScript(
        ...
        cues: [
            ...
            StoryCue(
                id: "ud_00",
                text: "자, 이제 「미운 아기 오리」 이야기를 시작할게요. 모두 귀를 쫑긋 세워 볼까요?",
                keyword: "시작",
                soundID: "once_upon_time"
            ),
            StoryCue(
                id: "ud_01",
                text: "어느 화창한 여름날, 농장 연못가 수풀에서 엄마 오리가 알을 품고 있었어요. 엄마 오리는 꽥꽥 울며 알들이 깨어나기만을 기다렸지요.",
                keyword: "엄마 오리",
                soundID: "duck_quack",
                delay: 0.5
            ),
            StoryCue(
                id: "ud_02",
                text: "드디어 알들이 톡톡 갈라지며 노랗고 보송보송한 아기 오리들이 태어났어요! '삐약삐약, 세상이 참 넓어요, 엄마!'",
                keyword: "톡톡",
            ...
            StoryCue(
                id: "ud_05",
                text: "아기 오리는 너무 슬퍼서 훌쩍훌쩍 울었어요. '아무도 나를 좋아하지 않아. 차라리 멀리 떠나 버릴 거야.' 아기 오리는 어느 날 밤 몰래 농장을 떠났어요.",
                keyword: "훌쩍훌쩍",
                soundID: "crying"
            ),
            StoryCue(
                id: "ud_06",
                text: "아기 오리는 넓은 늪가에 도착해 첨벙 물속으로 뛰어들었어요. 혼자서 헤엄치고 혼자서 잠들었지요. 들새들도 잿빛 아기 오리와는 놀아 주지 않았어요.",
                keyword: "첨벙",
                soundID: "water_splash"
            ),
            StoryCue(
                id: "ud_07",
                text: "가을이 가고 겨울이 왔어요. 살을 에는 겨울바람이 늪 위로 매섭게 몰아쳤지요. 아기 오리는 깃털을 잔뜩 부풀리고 추위를 견뎠어요.",
                keyword: "겨울바람이",
                soundID: "wind_howl",
                delay: 0.3
            ),
            StoryCue(
                id: "ud_08",
                text: "먹이를 찾아 꽁꽁 언 눈밭을 헤매기도 했어요. 발이 시리고 배가 고팠지만, 아기 오리는 꿋꿋하게 긴 겨울을 버텨 냈답니다.",
                keyword: "눈밭을",
                soundID: "snow_crunch",
                delay: 0.3
            ),
            StoryCue(
                id: "ud_09",
                text: "마침내 따뜻한 봄이 왔어요! 얼음이 녹고 새싹이 돋아나고, 아침마다 맑은 새소리가 울려 퍼졌지요. 아기 오리는 기지개를 켜고 날개를 활짝 펴 보았어요. 날개가 몰라보게 크고 힘차졌어요.",
                keyword: "봄이",
            ...
            StoryCue(
                id: "ud_10",
                text: "호수 위에 눈부시게 새하얀 새들이 우아하게 떠 있었어요. 아기 오리는 숨을 헉 들이켰지요. '세상에, 저렇게 아름다운 새들이 있다니!'",
                keyword: "새하얀",
                soundID: "gasp_surprise",
                delay: 0.3
            ),
